...
export class SpiroGraph {
	constructor() {
        ...
        this.tightness = 0//randomInteger(-1, 1) // how curvy/sharp the pattern's curves are
        ...
        this.initialSineAngleChange = 0.02
        this.initialSineAngle = 0
        this.numSines = randomInteger(4, 5)
        this.renderCutoff = 0
        this.initialSineScale = (width/(2))/(3.5)
        this.lineThickness = 2;
        this.maxRotations = 1.3
        this.subSineScale = randomReal(0.7, 0.9)

        this.colour = color(22, 177, 224, 10); // line colour
